...
public abstract class Orchestrator {
	...
	protected abstract ComputingNode findComputingNode(String[] architecture, Task task);

	//protected void assignTaskToComputingNode(int nodeIndex, Task task) {
	protected void assignTaskToComputingNode(ComputingNode node, Task task) {
		//System.out.println("AKHIRUL-assignTaskToComputingNode: " + task.getId() + " jobid: " + task.getApplicationID());
		if (node != null) {
			...
			simLog.deepLog(simulationManager.getSimulation().clock() + ": " + this.getClass() + " Job Id: " + task.getApplicationID() + " Task: " + task.getId()
