...
public interface ComputingNode {
	...
	void setReadBandwidth(long readBandwidth);
	long getWriteBandwidth();
	void setWriteBandwidth(long writeBandwidth);
	boolean isPimEnabled();
	void setPimEnabled(boolean pimEnabled);
	double getPimMips();

	void setPimMips(double pimMips);

	double getDataBusBandwidth();

	void setDataBusBandwidth(double dataBusBandwidth);
	void setGpuNumbers(int gpu_num);
	int getGpuNumbers();
	boolean isGpuEnabled();
	void setGpuEnabled(boolean gpuEnabled);
	double getNumberOfGPUCores();
	void setNumberOfGPUCores(double numberOfGPUCores);
	double getGpuMipsPerCore();
	void setGpuMipsPerCore(double gpuMipsPerCore);
