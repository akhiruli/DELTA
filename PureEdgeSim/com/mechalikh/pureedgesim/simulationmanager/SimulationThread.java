...
import first_problem.CustomSimMananger;
...
public class SimulationThread {
	...
	public void startSimulation() {
		...
		try {
			...
			for (int it = fromIteration; it < simulation.getScenarios().size(); it += step) {
				...
				simulationManager = new CustomSimMananger(simLog, pureEdgeSim, simulationId, iteration,
				...
				((CustomSimMananger)simulationManager).setPureEdgeSim(pureEdgeSim);
	...
	private void loadModels(SimulationManager simulationManager) throws Exception {
		...
		System.out.println("Tasks generated " + tasksList.size());
